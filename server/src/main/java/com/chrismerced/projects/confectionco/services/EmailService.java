...
public interface EmailService {
    ...
    void sendDepositPaymentLink(String recipient, String url, java.math.BigDecimal depositAmount, java.math.BigDecimal orderTotal);
    void sendFinalPaymentLink(String recipient, String url, java.math.BigDecimal amount);
    ...
    void sendOrderRejection(String recipient);
}
